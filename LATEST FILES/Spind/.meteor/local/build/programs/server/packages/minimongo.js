    ...
    compileElementSelector: function (operand) {                                                                       // 540
      ...
      return function (value) {                                                                                        // 558
        ...
        return cmpValueComparator(LocalCollection._f._cmp(value, operand));                                            // 565
                                                                                                                       ...
                                                                                                                       //
var isBitSet = function (value, bit) {                                                                                 // 571
  if (value === 0) return false;                                                                                       // 572
  return (value & 1 << bit) !== 0;                                                                                     // 574
};                                                                                                                     // 575
                                                                                                                       //
var eightBits = [0, 1, 2, 3, 4, 5, 6, 7];                                                                              // 577
                                                                                                                       //
var get8BitsSet = function (value) {                                                                                   // 578
  if (value === 0) return [];                                                                                          // 579
  return _.filter(eightBits, function (bit) {                                                                          // 581
    return isBitSet(value, bit);                                                                                       // 582
  });                                                                                                                  // 583
};                                                                                                                     // 584
                                                                                                                       //
var convertNumberToUint8Array = function (number) {                                                                    // 586
  var numOfBits = number.toString(2).length;                                                                           // 587
  var num8BitGroups = Math.ceil(numOfBits / 8);                                                                        // 588
  var byteArray = new Uint8Array(num8BitGroups);                                                                       // 589
                                                                                                                       //
  for (var i = 0; i < byteArray.length; i++) {                                                                         // 591
    var byte = number & 0xff;                                                                                          // 592
    byteArray[i] = byte;                                                                                               // 593
    number = (number - byte) / 256;                                                                                    // 594
  }                                                                                                                    // 595
                                                                                                                       //
  return byteArray;                                                                                                    // 597
};                                                                                                                     // 598
                                                                                                                       //
var ensureUint8Array = function (number) {                                                                             // 600
  return number instanceof Uint8Array ? number : convertNumberToUint8Array(number);                                    // 601
};                                                                                                                     // 603
                                                                                                                       //
var ensureOperandUint8Array = function (operand) {                                                                     // 605
  if (!(operand instanceof Uint8Array)) {                                                                              // 606
    operand = _.reduce(operand, function (num, n) {                                                                    // 607
      return num | 1 << n;                                                                                             // 608
    }, 0);                                                                                                             // 609
    operand = convertNumberToUint8Array(operand);                                                                      // 611
  }                                                                                                                    // 612
                                                                                                                       //
  return operand;                                                                                                      // 614
};                                                                                                                     // 615
                                                                                                                       //
var bitsClear = function (bitsSetOp, bitsSetVal) {                                                                     // 617
  return _.isUndefined(_.find(bitsSetOp, function (bit) {                                                              // 618
    return bitsSetVal.indexOf(bit) === -1;                                                                             // 620
  }));                                                                                                                 // 621
};                                                                                                                     // 623
                                                                                                                       //
var bitsSet = function (bitsSetOp, bitsSetVal) {                                                                       // 625
  return _.isUndefined(_.find(bitsSetOp, function (bit) {                                                              // 626
    return bitsSetVal.indexOf(bit) !== -1;                                                                             // 628
  }));                                                                                                                 // 629
};                                                                                                                     // 631
                                                                                                                       //
var anyBitCompare = function (operand, value, setOrClear) {                                                            // 633
  return _.isUndefined(_.find(operand, function (op, i) {                                                              // 634
    ...
    return setOrClear(bitsSetOp, bitsSetVal);                                                                          // 639
                                                                                                                       ...
                                                                                                                       //
var allBitCompare = function (operand, value, setOrClear) {                                                            // 644
  return _.filter(operand, function (op, i) {                                                                          // 645
    var bitsSetOp = get8BitsSet(op);                                                                                   // 646
    var bitsSetVal = get8BitsSet(value[i]);                                                                            // 647
    return !setOrClear(bitsSetOp, bitsSetVal);                                                                         // 649
  }).length === 0;                                                                                                     // 650
}; // Each element selector contains:                                                                                  // 651
//  - compileElementSelector, a function with args:                                                                    // 654
//    - operand - the "right hand side" of the operator                                                                // 655
//    - valueSelector - the "context" for the operator (so that $regex can find                                        // 656
//      $options)                                                                                                      // 657
//    - matcher - the Matcher this is going into (so that $elemMatch can compile                                       // 658
//      more things)                                                                                                   // 659
//    returning a function mapping a single value to bool.                                                             // 660
//  - dontExpandLeafArrays, a bool which prevents expandArraysInBranches from                                          // 661
//    being called                                                                                                     // 662
//  - dontIncludeLeafArrays, a bool which causes an argument to be passed to                                           // 663
//    expandArraysInBranches if it is called                                                                           // 664
                                                                                                                       //
                                                                                                                       //
ELEMENT_OPERATORS = {                                                                                                  // 665
  $lt: makeInequality(function (cmpValue) {                                                                            // 666
    return cmpValue < 0;                                                                                               // 667
  }),                                                                                                                  // 668
  $gt: makeInequality(function (cmpValue) {                                                                            // 669
    return cmpValue > 0;                                                                                               // 670
  }),                                                                                                                  // 671
  $lte: makeInequality(function (cmpValue) {                                                                           // 672
    return cmpValue <= 0;                                                                                              // 673
  }),                                                                                                                  // 674
  $gte: makeInequality(function (cmpValue) {                                                                           // 675
    return cmpValue >= 0;                                                                                              // 676
  }),                                                                                                                  // 677
  $mod: {                                                                                                              // 678
    compileElementSelector: function (operand) {                                                                       // 679
      if (!(isArray(operand) && operand.length === 2 && typeof operand[0] === 'number' && typeof operand[1] === 'number')) {
        throw Error("argument to $mod must be an array of two numbers");                                               // 683
      } // XXX could require to be ints or round or something                                                          // 684
                                                                                                                       //
                                                                                                                       //
      var divisor = operand[0];                                                                                        // 686
      var remainder = operand[1];                                                                                      // 687
      return function (value) {                                                                                        // 688
        return typeof value === 'number' && value % divisor === remainder;                                             // 689
      };                                                                                                               // 690
    }                                                                                                                  // 691
  },                                                                                                                   // 678
  $in: {                                                                                                               // 693
    compileElementSelector: function (operand) {                                                                       // 694
      if (!isArray(operand)) throw Error("$in needs an array");                                                        // 695
      var elementMatchers = [];                                                                                        // 698
                                                                                                                       //
      _.each(operand, function (option) {                                                                              // 699
        if (option instanceof RegExp) elementMatchers.push(regexpElementMatcher(option));else if (isOperatorObject(option)) throw Error("cannot nest $ under $in");else elementMatchers.push(equalityElementMatcher(option));
                                                                                                                       ...
                                                                                                                       //
      return function (value) {                                                                                        // 708
        // Allow {a: {$in: [null]}} to match when 'a' does not exist.                                                  // 709
        if (value === undefined) value = null;                                                                         // 710
        return _.any(elementMatchers, function (e) {                                                                   // 712
          return e(value);                                                                                             // 713
        });                                                                                                            // 714
      };                                                                                                               // 715
    }                                                                                                                  // 716
  ...
  $size: {                                                                                                             // 718
    // {a: [[5, 5]]} must match {a: {$size: 1}} but not {a: {$size: 2}}, so we                                         // 719
    // don't want to consider the element [5,5] in the leaf array [[5,5]] as a                                         // 720
    // possible value.                                                                                                 // 721
    dontExpandLeafArrays: true,                                                                                        // 722
    compileElementSelector: function (operand) {                                                                       // 723
      if (typeof operand === 'string') {                                                                               // 724
        // Don't ask me why, but by experimentation, this seems to be what Mongo                                       // 725
        // does.                                                                                                       // 726
        operand = 0;                                                                                                   // 727
      } else if (typeof operand !== 'number') {                                                                        // 728
        throw Error("$size needs a number");                                                                           // 729
      }                                                                                                                // 730
                                                                                                                       //
      return function (value) {                                                                                        // 731
        return isArray(value) && value.length === operand;                                                             // 732
      };                                                                                                               // 733
    }                                                                                                                  // 734
  },                                                                                                                   // 718
  $type: {                                                                                                             // 736
    // {a: [5]} must not match {a: {$type: 4}} (4 means array), but it should                                          // 737
    // match {a: {$type: 1}} (1 means number), and {a: [[5]]} must match {$a:                                          // 738
    // {$type: 4}}. Thus, when we see a leaf array, we *should* expand it but                                          // 739
    // should *not* include it itself.                                                                                 // 740
    dontIncludeLeafArrays: true,                                                                                       // 741
    compileElementSelector: function (operand) {                                                                       // 742
      if (typeof operand !== 'number') throw Error("$type needs a number");                                            // 743
      return function (value) {                                                                                        // 745
        return value !== undefined && LocalCollection._f._type(value) === operand;                                     // 746
      };                                                                                                               // 748
    }                                                                                                                  // 749
  },                                                                                                                   // 736
  $bitsAnyClear: {                                                                                                     // 751
    compileElementSelector: function (operand, valueSelector, matcher) {                                               // 752
      if (!isArray(operand) && !(operand instanceof Uint8Array)) throw Error("$bitsAnyClear has to be an Array");      // 753
      return function (value) {                                                                                        // 755
        if (typeof value !== 'number' && !(value instanceof Uint8Array)) return false;                                 // 756
        if (value === 0) return true;                                                                                  // 759
        operand = ensureOperandUint8Array(operand);                                                                    // 762
        value = ensureUint8Array(value);                                                                               // 763
        return anyBitCompare(operand, value, bitsClear);                                                               // 765
      };                                                                                                               // 766
    }                                                                                                                  // 767
  },                                                                                                                   // 751
  $bitsAllClear: {                                                                                                     // 769
    compileElementSelector: function (operand, valueSelector, matcher) {                                               // 770
      if (!isArray(operand) && !(operand instanceof Uint8Array)) throw Error("$bitsAllClear has to be an Array");      // 771
      return function (value) {                                                                                        // 773
        if (typeof value !== 'number' && !(value instanceof Uint8Array)) return false;                                 // 774
        if (value === 0) return true;                                                                                  // 777
        operand = ensureOperandUint8Array(operand);                                                                    // 780
        value = ensureUint8Array(value);                                                                               // 781
        return allBitCompare(operand, value, bitsSet);                                                                 // 783
      };                                                                                                               // 784
    }                                                                                                                  // 785
  },                                                                                                                   // 769
  $bitsAllSet: {                                                                                                       // 787
    compileElementSelector: function (operand, valueSelector, matcher) {                                               // 788
      if (!isArray(operand) && !(operand instanceof Uint8Array)) throw Error("$bitsAllSet has to be an Array");        // 789
      return function (value) {                                                                                        // 791
        if (typeof value !== 'number' && !(value instanceof Uint8Array)) return false;                                 // 792
        operand = ensureOperandUint8Array(operand);                                                                    // 795
        value = ensureUint8Array(value);                                                                               // 796
        return allBitCompare(operand, value, bitsClear);                                                               // 798
      };                                                                                                               // 799
    }                                                                                                                  // 800
  },                                                                                                                   // 787
  $bitsAnySet: {                                                                                                       // 802
    compileElementSelector: function (operand, valueSelector, matcher) {                                               // 803
      if (!isArray(operand) && !(operand instanceof Uint8Array)) throw Error("$bitsAnySet has to be an Array");        // 804
      return function (value) {                                                                                        // 806
        if (typeof value !== 'number' && !(value instanceof Uint8Array)) return false;                                 // 807
        operand = ensureOperandUint8Array(operand);                                                                    // 810
        value = ensureUint8Array(value);                                                                               // 811
        return _.isUndefined(_.find(operand, function (op, i) {                                                        // 813
          var bitsSetOp = get8BitsSet(op);                                                                             // 815
          var bitsSetVal = get8BitsSet(value[i]);                                                                      // 816
          return bitsSet(bitsSetOp, bitsSetVal);                                                                       // 818
        }));                                                                                                           // 819
      };                                                                                                               // 821
    }                                                                                                                  // 822
  },                                                                                                                   // 802
  $regex: {                                                                                                            // 824
    compileElementSelector: function (operand, valueSelector) {                                                        // 825
      if (!(typeof operand === 'string' || operand instanceof RegExp)) throw Error("$regex has to be a string or RegExp");
      var regexp;                                                                                                      // 829
                                                                                                                       //
      if (valueSelector.$options !== undefined) {                                                                      // 830
        // Options passed in $options (even the empty string) always overrides                                         // 831
        // options in the RegExp object itself. (See also                                                              // 832
        // Mongo.Collection._rewriteSelector.)                                                                         // 833
        // Be clear that we only support the JS-supported options, not extended                                        // 835
        // ones (eg, Mongo supports x and s). Ideally we would implement x and s                                       // 836
        // by transforming the regexp, but not today...                                                                // 837
        if (/[^gim]/.test(valueSelector.$options)) throw new Error("Only the i, m, and g regexp options are supported");
        var regexSource = operand instanceof RegExp ? operand.source : operand;                                        // 841
        regexp = new RegExp(regexSource, valueSelector.$options);                                                      // 842
      } else if (operand instanceof RegExp) {                                                                          // 843
        regexp = operand;                                                                                              // 844
      } else {                                                                                                         // 845
        regexp = new RegExp(operand);                                                                                  // 846
      }                                                                                                                // 847
                                                                                                                       //
      return regexpElementMatcher(regexp);                                                                             // 848
    }                                                                                                                  // 849
  },                                                                                                                   // 824
  $elemMatch: {                                                                                                        // 851
    dontExpandLeafArrays: true,                                                                                        // 852
    compileElementSelector: function (operand, valueSelector, matcher) {                                               // 853
      if (!isPlainObject(operand)) throw Error("$elemMatch need an object");                                           // 854
      var subMatcher, isDocMatcher;                                                                                    // 857
                                                                                                                       //
      if (isOperatorObject(_.omit(operand, _.keys(LOGICAL_OPERATORS)), true)) {                                        // 858
        subMatcher = compileValueSelector(operand, matcher);                                                           // 859
        isDocMatcher = false;                                                                                          // 860
      } else {                                                                                                         // 861
        // This is NOT the same as compileValueSelector(operand), and not just                                         // 862
        // because of the slightly different calling convention.                                                       // 863
        // {$elemMatch: {x: 3}} means "an element has a field x:3", not                                                // 864
        // "consists only of a field x:3". Also, regexps and sub-$ are allowed.                                        // 865
        subMatcher = compileDocumentSelector(operand, matcher, {                                                       // 866
          inElemMatch: true                                                                                            // 867
        });                                                                                                            // 867
        isDocMatcher = true;                                                                                           // 868
      }                                                                                                                // 869
                                                                                                                       //
      return function (value) {                                                                                        // 871
        if (!isArray(value)) return false;                                                                             // 872
                                                                                                                       //
        for (var i = 0; i < value.length; ++i) {                                                                       // 874
          var arrayElement = value[i];                                                                                 // 875
          var arg;                                                                                                     // 876
                                                                                                                       //
          if (isDocMatcher) {                                                                                          // 877
            // We can only match {$elemMatch: {b: 3}} against objects.                                                 // 878
            // (We can also match against arrays, if there's numeric indices,                                          // 879
            // eg {$elemMatch: {'0.b': 3}} or {$elemMatch: {0: 3}}.)                                                   // 880
            if (!isPlainObject(arrayElement) && !isArray(arrayElement)) return false;                                  // 881
            arg = arrayElement;                                                                                        // 883
          } else {                                                                                                     // 884
            // dontIterate ensures that {a: {$elemMatch: {$gt: 5}}} matches                                            // 885
            // {a: [8]} but not {a: [[8]]}                                                                             // 886
            arg = [{                                                                                                   // 887
              value: arrayElement,                                                                                     // 887
              dontIterate: true                                                                                        // 887
            }];                                                                                                        // 887
          } // XXX support $near in $elemMatch by propagating $distance?                                               // 888
                                                                                                                       //
                                                                                                                       //
          if (subMatcher(arg).result) return i; // specially understood to mean "use as arrayIndices"                  // 890
        }                                                                                                              // 892
                                                                                                                       //
        return false;                                                                                                  // 893
      };                                                                                                               // 894
...
}; // makeLookupFunction(key) returns a lookup function.                                                               // 665
//                                                                                                                     // 900
// A lookup function takes in a document and returns an array of matching                                              // 901
// branches.  If no arrays are found while looking up the key, this array will                                         // 902
// have exactly one branches (possibly 'undefined', if some segment of the key                                         // 903
// was not found).                                                                                                     // 904
//                                                                                                                     // 905
// If arrays are found in the middle, this can have more than one element, since                                       // 906
// we "branch". When we "branch", if there are more key segments to look up,                                           // 907
// then we only pursue branches that are plain objects (not arrays or scalars).                                        // 908
// This means we can actually end up with no branches!                                                                 // 909
//                                                                                                                     // 910
// We do *NOT* branch on arrays that are found at the end (ie, at the last                                             // 911
// dotted member of the key). We just return that array; if you want to                                                // 912
// effectively "branch" over the array's values, post-process the lookup                                               // 913
// function with expandArraysInBranches.                                                                               // 914
//                                                                                                                     // 915
// Each branch is an object with keys:                                                                                 // 916
//  - value: the value at the branch                                                                                   // 917
//  - dontIterate: an optional bool; if true, it means that 'value' is an array                                        // 918
//    that expandArraysInBranches should NOT expand. This specifically happens                                         // 919
//    when there is a numeric index in the key, and ensures the                                                        // 920
//    perhaps-surprising MongoDB behavior where {'a.0': 5} does NOT                                                    // 921
//    match {a: [[5]]}.                                                                                                // 922
//  - arrayIndices: if any array indexing was done during lookup (either due to                                        // 923
//    explicit numeric indices or implicit branching), this will be an array of                                        // 924
//    the array indices used, from outermost to innermost; it is falsey or                                             // 925
//    absent if no array index is used. If an explicit numeric index is used,                                          // 926
//    the index will be followed in arrayIndices by the string 'x'.                                                    // 927
//                                                                                                                     // 928
//    Note: arrayIndices is used for two purposes. First, it is used to                                                // 929
//    implement the '$' modifier feature, which only ever looks at its first                                           // 930
//    element.                                                                                                         // 931
//                                                                                                                     // 932
//    Second, it is used for sort key generation, which needs to be able to tell                                       // 933
//    the difference between different paths. Moreover, it needs to                                                    // 934
//    differentiate between explicit and implicit branching, which is why                                              // 935
//    there's the somewhat hacky 'x' entry: this means that explicit and                                               // 936
//    implicit array lookups will have different full arrayIndices paths. (That                                        // 937
//    code only requires that different paths have different arrayIndices; it                                          // 938
//    doesn't actually "parse" arrayIndices. As an alternative, arrayIndices                                           // 939
//    could contain objects with flags like "implicit", but I think that only                                          // 940
//    makes the code surrounding them more complex.)                                                                   // 941
//                                                                                                                     // 942
//    (By the way, this field ends up getting passed around a lot without                                              // 943
//    cloning, so never mutate any arrayIndices field/var in this package!)                                            // 944
//                                                                                                                     // 945
//                                                                                                                     // 946
// At the top level, you may only pass in a plain object or array.                                                     // 947
//                                                                                                                     // 948
// See the test 'minimongo - lookup' for some examples of what lookup functions                                        // 949
// return.                                                                                                             // 950
                                                                                                                       //
makeLookupFunction = function (key, options) {                                                                         // 951
  options = options || {};                                                                                             // 952
  var parts = key.split('.');                                                                                          // 953
  var firstPart = parts.length ? parts[0] : '';                                                                        // 954
  var firstPartIsNumeric = isNumericKey(firstPart);                                                                    // 955
  var nextPartIsNumeric = parts.length >= 2 && isNumericKey(parts[1]);                                                 // 956
  var lookupRest;                                                                                                      // 957
                                                                                                                       //
  if (parts.length > 1) {                                                                                              // 958
    lookupRest = makeLookupFunction(parts.slice(1).join('.'));                                                         // 959
  }                                                                                                                    // 960
                                                                                                                       //
  var omitUnnecessaryFields = function (retVal) {                                                                      // 962
    if (!retVal.dontIterate) delete retVal.dontIterate;                                                                // 963
    if (retVal.arrayIndices && !retVal.arrayIndices.length) delete retVal.arrayIndices;                                // 965
    return retVal;                                                                                                     // 967
  }; // Doc will always be a plain object or an array.                                                                 // 968
  // apply an explicit numeric index, an array.                                                                        // 971
                                                                                                                       //
                                                                                                                       //
  return function (doc, arrayIndices) {                                                                                // 972
    if (!arrayIndices) arrayIndices = [];                                                                              // 973
                                                                                                                       //
    if (isArray(doc)) {                                                                                                // 976
      // If we're being asked to do an invalid lookup into an array (non-integer                                       // 977
      // or out-of-bounds), return no results (which is different from returning                                       // 978
      // a single undefined result, in that `null` equality checks won't match).                                       // 979
      if (!(firstPartIsNumeric && firstPart < doc.length)) return []; // Remember that we used this array index. Include an 'x' to indicate that
      // the previous index came from being considered as an explicit array                                            // 984
      // index (not branching).                                                                                        // 985
                                                                                                                       //
      arrayIndices = arrayIndices.concat(+firstPart, 'x');                                                             // 986
    } // Do our first lookup.                                                                                          // 987
                                                                                                                       //
                                                                                                                       //
    var firstLevel = doc[firstPart]; // If there is no deeper to dig, return what we found.                            // 990
    //                                                                                                                 // 993
    // If what we found is an array, most value selectors will choose to treat                                         // 994
    // the elements of the array as matchable values in their own right, but                                           // 995
    // that's done outside of the lookup function. (Exceptions to this are $size                                       // 996
    // and stuff relating to $elemMatch.  eg, {a: {$size: 2}} does not match {a:                                       // 997
    // [[1, 2]]}.)                                                                                                     // 998
    //                                                                                                                 // 999
    // That said, if we just did an *explicit* array lookup (on doc) to find                                           // 1000
    // firstLevel, and firstLevel is an array too, we do NOT want value                                                // 1001
    // selectors to iterate over it.  eg, {'a.0': 5} does not match {a: [[5]]}.                                        // 1002
    // So in that case, we mark the return value as "don't iterate".                                                   // 1003
                                                                                                                       //
    if (!lookupRest) {                                                                                                 // 1004
      return [omitUnnecessaryFields({                                                                                  // 1005
        value: firstLevel,                                                                                             // 1006
        dontIterate: isArray(doc) && isArray(firstLevel),                                                              // 1007
        arrayIndices: arrayIndices                                                                                     // 1008
      })];                                                                                                             // 1005
    } // We need to dig deeper.  But if we can't, because what we've found is not                                      // 1009
    // an array or plain object, we're done. If we just did a numeric index into                                       // 1012
    // an array, we return nothing here (this is a change in Mongo 2.5 from                                            // 1013
    // Mongo 2.4, where {'a.0.b': null} stopped matching {a: [5]}). Otherwise,                                         // 1014
    // return a single `undefined` (which can, for example, match via equality                                         // 1015
    // with `null`).                                                                                                   // 1016
                                                                                                                       //
                                                                                                                       //
    if (!isIndexable(firstLevel)) {                                                                                    // 1017
      if (isArray(doc)) return [];                                                                                     // 1018
      return [omitUnnecessaryFields({                                                                                  // 1020
        value: undefined,                                                                                              // 1020
    ...
    var result = [];                                                                                                   // 1024
                                                                                                                       //
    var appendToResult = function (more) {                                                                             // 1025
      Array.prototype.push.apply(result, more);                                                                        // 1026
    }; // Dig deeper: look up the rest of the parts on whatever we've found.                                           // 1027
    // (lookupRest is smart enough to not try to do invalid lookups into                                               // 1030
    // firstLevel if it's an array.)                                                                                   // 1031
                                                                                                                       //
                                                                                                                       //
    appendToResult(lookupRest(firstLevel, arrayIndices)); // If we found an array, then in *addition* to potentially treating the next
    // part as a literal integer lookup, we should also "branch": try to look up                                       // 1035
    // the rest of the parts on each array element in parallel.                                                        // 1036
    //                                                                                                                 // 1037
    // In this case, we *only* dig deeper into array elements that are plain                                           // 1038
    // objects. (Recall that we only got this far if we have further to dig.)                                          // 1039
    // This makes sense: we certainly don't dig deeper into non-indexable                                              // 1040
    // objects. And it would be weird to dig into an array: it's simpler to have                                       // 1041
    // a rule that explicit integer indexes only apply to an outer array, not to                                       // 1042
    // an array you find after a branching search.                                                                     // 1043
    //                                                                                                                 // 1044
    // In the special case of a numeric part in a *sort selector* (not a query                                         // 1045
    // selector), we skip the branching: we ONLY allow the numeric part to mean                                        // 1046
    // "look up this index" in that case, not "also look up this index in all                                          // 1047
    // the elements of the array".                                                                                     // 1048
                                                                                                                       //
    if (isArray(firstLevel) && !(nextPartIsNumeric && options.forSort)) {                                              // 1049
      _.each(firstLevel, function (branch, arrayIndex) {                                                               // 1050
        if (isPlainObject(branch)) {                                                                                   // 1051
          appendToResult(lookupRest(branch, arrayIndices.concat(arrayIndex)));                                         // 1052
        }                                                                                                              // 1055
      });                                                                                                              // 1056
    }                                                                                                                  // 1057
                                                                                                                       //
    return result;                                                                                                     // 1059
                                                                                                                       ...
                                                                                                                       //
MinimongoTest.makeLookupFunction = makeLookupFunction;                                                                 // 1062
                                                                                                                       //
expandArraysInBranches = function (branches, skipTheArrays) {                                                          // 1064
  var branchesOut = [];                                                                                                // 1065
                                                                                                                       //
  _.each(branches, function (branch) {                                                                                 // 1066
    var thisIsArray = isArray(branch.value); // We include the branch itself, *UNLESS* we it's an array that we're going
    // to iterate and we're told to skip arrays.  (That's right, we include some                                       // 1069
    // arrays even skipTheArrays is true: these are arrays that were found via                                         // 1070
    // explicit numerical indices.)                                                                                    // 1071
                                                                                                                       //
    if (!(skipTheArrays && thisIsArray && !branch.dontIterate)) {                                                      // 1072
      branchesOut.push({                                                                                               // 1073
        value: branch.value,                                                                                           // 1074
        arrayIndices: branch.arrayIndices                                                                              // 1075
      });                                                                                                              // 1073
    }                                                                                                                  // 1077
                                                                                                                       //
    if (thisIsArray && !branch.dontIterate) {                                                                          // 1078
      _.each(branch.value, function (leaf, i) {                                                                        // 1079
        branchesOut.push({                                                                                             // 1080
          value: leaf,                                                                                                 // 1081
          arrayIndices: (branch.arrayIndices || []).concat(i)                                                          // 1082
        });                                                                                                            // 1080
      });                                                                                                              // 1084
    }                                                                                                                  // 1085
  });                                                                                                                  // 1086
                                                                                                                       //
  return branchesOut;                                                                                                  // 1087
};                                                                                                                     // 1088
                                                                                                                       //
var nothingMatcher = function (docOrBranchedValues) {                                                                  // 1090
  return {                                                                                                             // 1091
    result: false                                                                                                      // 1091
  };                                                                                                                   // 1091
};                                                                                                                     // 1092
                                                                                                                       //
var everythingMatcher = function (docOrBranchedValues) {                                                               // 1094
  return {                                                                                                             // 1095
    result: true                                                                                                       // 1095
  };                                                                                                                   // 1095
}; // NB: We are cheating and using this function to implement "AND" for both                                          // 1096
// "document matchers" and "branched matchers". They both return result objects                                        // 1100
// but the argument is different: for the former it's a whole doc, whereas for                                         // 1101
// the latter it's an array of "branched values".                                                                      // 1102
                                                                                                                       //
                                                                                                                       //
var andSomeMatchers = function (subMatchers) {                                                                         // 1103
  if (subMatchers.length === 0) return everythingMatcher;                                                              // 1104
  if (subMatchers.length === 1) return subMatchers[0];                                                                 // 1106
  return function (docOrBranches) {                                                                                    // 1109
    var ret = {};                                                                                                      // 1110
    ret.result = _.all(subMatchers, function (f) {                                                                     // 1111
      var subResult = f(docOrBranches); // Copy a 'distance' number out of the first sub-matcher that has              // 1112
      // one. Yes, this means that if there are multiple $near fields in a                                             // 1114
      // query, something arbitrary happens; this appears to be consistent with                                        // 1115
      // Mongo.                                                                                                        // 1116
                                                                                                                       //
      if (subResult.result && subResult.distance !== undefined && ret.distance === undefined) {                        // 1117
        ret.distance = subResult.distance;                                                                             // 1119
      } // Similarly, propagate arrayIndices from sub-matchers... but to match                                         // 1120
      // MongoDB behavior, this time the *last* sub-matcher with arrayIndices                                          // 1122
      // wins.                                                                                                         // 1123
                                                                                                                       //
                                                                                                                       //
      if (subResult.result && subResult.arrayIndices) {                                                                // 1124
        ret.arrayIndices = subResult.arrayIndices;                                                                     // 1125
      }                                                                                                                // 1126
                                                                                                                       //
      return subResult.result;                                                                                         // 1127
    }); // If we didn't actually match, forget any extra metadata we came up with.                                     // 1128
                                                                                                                       //
    if (!ret.result) {                                                                                                 // 1131
      delete ret.distance;                                                                                             // 1132
      delete ret.arrayIndices;                                                                                         // 1133
    }                                                                                                                  // 1134
                                                                                                                       //
    return ret;                                                                                                        // 1135
  };                                                                                                                   // 1136
                                                                                                                       ...
                                                                                                                       //
var andDocumentMatchers = andSomeMatchers;                                                                             // 1139
var andBranchedMatchers = andSomeMatchers; // helpers used by compiled selector code                                   // 1140
                                                                                                                       //
LocalCollection._f = {                                                                                                 // 1144
  // XXX for _all and _in, consider building 'inquery' at compile time..                                               // 1145
  _type: function (v) {                                                                                                // 1147
    if (typeof v === "number") return 1;                                                                               // 1148
    if (typeof v === "string") return 2;                                                                               // 1150
    if (typeof v === "boolean") return 8;                                                                              // 1152
    if (isArray(v)) return 4;                                                                                          // 1154
    if (v === null) return 10;                                                                                         // 1156
    if (v instanceof RegExp) // note that typeof(/x/) === "object"                                                     // 1158
      return 11;                                                                                                       // 1160
    if (typeof v === "function") return 13;                                                                            // 1161
    if (v instanceof Date) return 9;                                                                                   // 1163
    if (EJSON.isBinary(v)) return 5;                                                                                   // 1165
    if (v instanceof MongoID.ObjectID) return 7;                                                                       // 1167
    return 3; // object                                                                                                // 1169
    // XXX support some/all of these:                                                                                  // 1171
    // 14, symbol                                                                                                      // 1172
    // 15, javascript code with scope                                                                                  // 1173
    // 16, 18: 32-bit/64-bit integer                                                                                   // 1174
    // 17, timestamp                                                                                                   // 1175
    // 255, minkey                                                                                                     // 1176
    // 127, maxkey                                                                                                     // 1177
  },                                                                                                                   // 1178
  // deep equality test: use for literal document and array matches                                                    // 1180
  _equal: function (a, b) {                                                                                            // 1181
    return EJSON.equals(a, b, {                                                                                        // 1182
      keyOrderSensitive: true                                                                                          // 1182
    });                                                                                                                // 1182
  },                                                                                                                   // 1183
  // maps a type code to a value that can be used to sort values of                                                    // 1185
  // different types                                                                                                   // 1186
  _typeorder: function (t) {                                                                                           // 1187
    // http://www.mongodb.org/display/DOCS/What+is+the+Compare+Order+for+BSON+Types                                    // 1188
    // XXX what is the correct sort position for Javascript code?                                                      // 1189
    // ('100' in the matrix below)                                                                                     // 1190
    // XXX minkey/maxkey                                                                                               // 1191
    return [-1, // (not a type)                                                                                        // 1192
    1, // number                                                                                                       // 1193
    2, // string                                                                                                       // 1194
    3, // object                                                                                                       // 1195
    4, // array                                                                                                        // 1196
    ...
    -1, // deprecated                                                                                                  // 1204
    100, // JS code                                                                                                    // 1205
    2, // deprecated (symbol)                                                                                          // 1206
    100, // JS code                                                                                                    // 1207
    1, // 32-bit int                                                                                                   // 1208
    8, // Mongo timestamp                                                                                              // 1209
    1 // 64-bit int                                                                                                    // 1210
    ][t];                                                                                                              // 1192
  },                                                                                                                   // 1212
  // compare two values of unknown type according to BSON ordering                                                     // 1214
  // semantics. (as an extension, consider 'undefined' to be less than                                                 // 1215
  // any other value.) return negative if a is less, positive if b is                                                  // 1216
  // less, or 0 if equal                                                                                               // 1217
  _cmp: function (a, b) {                                                                                              // 1218
    if (a === undefined) return b === undefined ? 0 : -1;                                                              // 1219
    if (b === undefined) return 1;                                                                                     // 1221
                                                                                                                       //
    var ta = LocalCollection._f._type(a);                                                                              // 1223
                                                                                                                       //
    var tb = LocalCollection._f._type(b);                                                                              // 1224
                                                                                                                       //
    var oa = LocalCollection._f._typeorder(ta);                                                                        // 1225
                                                                                                                       //
    var ob = LocalCollection._f._typeorder(tb);                                                                        // 1226
                                                                                                                       //
    if (oa !== ob) return oa < ob ? -1 : 1;                                                                            // 1227
    if (ta !== tb) // XXX need to implement this if we implement Symbol or integers, or                                // 1229
      // Timestamp                                                                                                     // 1231
      throw Error("Missing type coercion logic in _cmp");                                                              // 1232
                                                                                                                       //
    if (ta === 7) {                                                                                                    // 1233
      // ObjectID                                                                                                      // 1233
      // Convert to string.                                                                                            // 1234
      ta = tb = 2;                                                                                                     // 1235
      a = a.toHexString();                                                                                             // 1236
      b = b.toHexString();                                                                                             // 1237
    }                                                                                                                  // 1238
                                                                                                                       //
    if (ta === 9) {                                                                                                    // 1239
      // Date                                                                                                          // 1239
      // Convert to millis.                                                                                            // 1240
      ta = tb = 1;                                                                                                     // 1241
      a = a.getTime();                                                                                                 // 1242
      b = b.getTime();                                                                                                 // 1243
    }                                                                                                                  // 1244
    ...
    if (ta === 1) // double                                                                                            // 1246
      return a - b;                                                                                                    // 1247
    if (tb === 2) // string                                                                                            // 1248
      return a < b ? -1 : a === b ? 0 : 1;                                                                             // 1249
                                                                                                                       //
    if (ta === 3) {                                                                                                    // 1250
      // Object                                                                                                        // 1250
      // this could be much more efficient in the expected case ...                                                    // 1251
      var to_array = function (obj) {                                                                                  // 1252
        var ret = [];                                                                                                  // 1253
                                                                                                                       //
        for (var key in meteorBabelHelpers.sanitizeForInObject(obj)) {                                                 // 1254
          ret.push(key);                                                                                               // 1255
          ret.push(obj[key]);                                                                                          // 1256
        }                                                                                                              // 1257
                                                                                                                       //
        return ret;                                                                                                    // 1258
      };                                                                                                               // 1259
                                                                                                                       //
      return LocalCollection._f._cmp(to_array(a), to_array(b));                                                        // 1260
    }                                                                                                                  // 1261
                                                                                                                       //
    if (ta === 4) {                                                                                                    // 1262
      // Array                                                                                                         // 1262
      for (var i = 0;; i++) {                                                                                          // 1263
        if (i === a.length) return i === b.length ? 0 : -1;                                                            // 1264
        if (i === b.length) return 1;                                                                                  // 1266
                                                                                                                       //
        var s = LocalCollection._f._cmp(a[i], b[i]);                                                                   // 1268
                                                                                                                       //
        if (s !== 0) return s;                                                                                         // 1269
      }                                                                                                                // 1271
    }                                                                                                                  // 1272
                                                                                                                       //
    if (ta === 5) {                                                                                                    // 1273
      // binary                                                                                                        // 1273
      // Surprisingly, a small binary blob is always less than a large one in                                          // 1274
      // Mongo.                                                                                                        // 1275
      if (a.length !== b.length) return a.length - b.length;                                                           // 1276
                                                                                                                       //
      for (i = 0; i < a.length; i++) {                                                                                 // 1278
        if (a[i] < b[i]) return -1;                                                                                    // 1279
        if (a[i] > b[i]) return 1;                                                                                     // 1281
      }                                                                                                                // 1283
                                                                                                                       //
      return 0;                                                                                                        // 1284
    }                                                                                                                  // 1285
    ...
    if (ta === 8) {                                                                                                    // 1286
      // boolean                                                                                                       // 1286
      if (a) return b ? 0 : 1;                                                                                         // 1287
      return b ? -1 : 0;                                                                                               // 1288
    }                                                                                                                  // 1289
                                                                                                                       //
    if (ta === 10) // null                                                                                             // 1290
      return 0;                                                                                                        // 1291
    if (ta === 11) // regexp                                                                                           // 1292
      throw Error("Sorting not supported on regular expression"); // XXX                                               // 1293
    // 13: javascript code                                                                                             // 1294
    // 14: symbol                                                                                                      // 1295
    // 15: javascript code with scope                                                                                  // 1296
    // 16: 32-bit integer                                                                                              // 1297
    // 17: timestamp                                                                                                   // 1298
    // 18: 64-bit integer                                                                                              // 1299
    // 255: minkey                                                                                                     // 1300
    // 127: maxkey                                                                                                     // 1301
                                                                                                                       //
    if (ta === 13) // javascript code                                                                                  // 1302
      throw Error("Sorting not supported on Javascript code"); // XXX                                                  // 1303
                                                                                                                       //
    throw Error("Unknown type to sort");                                                                               // 1304
  }                                                                                                                    // 1305
}; // Oddball function used by upsert.                                                                                 // 1144
                                                                                                                       //
LocalCollection._removeDollarOperators = function (selector) {                                                         // 1309
  var selectorDoc = {};                                                                                                // 1310
                                                                                                                       //
  for (var k in meteorBabelHelpers.sanitizeForInObject(selector)) {                                                    // 1311
    if (k.substr(0, 1) !== '$') selectorDoc[k] = selector[k];                                                          // 1312
  }                                                                                                                    // 1311
                                                                                                                       //
  return selectorDoc;                                                                                                  // 1314
};                                                                                                                     // 1315
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
